...
public class AddGastoViewModel extends AndroidViewModel {
     ...
     */
    public LiveData<Boolean> addGasto(String name, String price, String createdAt, String categoria) {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                // O método addGasto envia os dados de um novo produto ao servidor. Ele retorna
                // um booleano indicando true caso o produto tenha sido cadastrado e false
                // em caso contrário
                boolean b = gastosRepository.addGasto(name, price, createdAt, categoria);
